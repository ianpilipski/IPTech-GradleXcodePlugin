...
class ProvisioningProfilesExecutorTest extends Specification {
    def "getUUIDMethod returns UUID of provisioning profile"() {
        ...
        expect:
        '7a8310e3-1a09-44ae-a22b-d18096c0a31b' == ProvisioningProfilesExecutor.getUUID(provisioningProfile)
    }
